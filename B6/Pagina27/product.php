...
$manga = $_GET['mangas'] ?? 'El manga no se encontró o no existe';
$enlace = $mangas[$manga] ?? 'No se ha encontrado el enlace de compra';
...
<p><strong>Enlace:</strong> <a href="<?= htmlspecialchars($enlace, ENT_QUOTES, 'UTF-8') ?>" target="_blank"><?= $enlace ?></a></p>
